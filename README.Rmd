...
readme_root <- tempfile("hyperion-readme-")
dir.create(readme_root, recursive = TRUE)
file.copy(
...
knitr::opts_knit$set(root.dir = readme_root)
```
...
get_model_lineage(file.path("models", "onecmt"))
```
