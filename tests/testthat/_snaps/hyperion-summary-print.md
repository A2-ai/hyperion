# hyperion.nonmem-summary print works
    ...
    Output
      ...
      ─────────  ────────  ──────  ───────  ─────
      TVCL       1.241     0.1129  9.096    No   
      TVV        40.86     3       7.343    No   
      TVKA       1.241     0.108   8.697    No   
    ...
    Output
      ...
      ──────────  ─────────────  ────────  ───────  ───────  ─────────────  ─────
      OM1 (TVCL)  ETA1           0.1309    0.05481  41.86    18.98          No   
      OM2 (TVV)   ETA2           0.1357    0.03891  28.68    4.909          No   
      OM3 (TVKA)  ETA3           0.1       NA       NA       NA             Yes  
...
---
    ...
    Output
      ...
      iteration  method  THETA1  THETA2  THETA3  SIGMA_1_1  SIGMA_2_1  SIGMA_2_2  OMEGA_1_1  OMEGA_2_1  OMEGA_2_2  OMEGA_3_1  OMEGA_3_2  OMEGA_3_3
      ─────────  ──────  ──────  ──────  ──────  ─────────  ─────────  ─────────  ─────────  ─────────  ─────────  ─────────  ─────────  ─────────
